...
dependencies {
    ...
    // Android/JVM-compatible disposable HTTP server used to exercise the production WebDAV
    // client without relying on JDK-internal com.sun.net.httpserver classes.
