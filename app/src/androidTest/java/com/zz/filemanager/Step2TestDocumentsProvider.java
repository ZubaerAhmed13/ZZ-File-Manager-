 ...
 *
 * This provider is deliberately Java-only. Android instantiates providers from the
 * instrumentation APK before the Kotlin instrumentation runtime/classloader is ready,
 * so keeping this bootstrap component free of Kotlin runtime dependencies makes the
 * deterministic API-35 SAF harness self-contained.
 */
public final class Step2TestDocumentsProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(String[] projection) {
        ...
        values.put(DocumentsContract.Root.COLUMN_SUMMARY, "Deterministic instrumentation tree");
