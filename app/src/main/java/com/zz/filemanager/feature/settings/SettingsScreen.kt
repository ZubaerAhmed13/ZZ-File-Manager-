...
fun SettingsScreen(viewModel: SettingsViewModel, onBack: () -> Unit) {
    ...
    Scaffold(topBar = { TopAppBar(title = { Text(stringResource(R.string.settings)) }, navigationIcon = { IconButton(onClick = onBack) { Icon(Icons.Default.ArrowBack, contentDescription = stringResource(R.string.home)) } }) }) { padding -> LazyColumn(Modifier.fillMaxSize().padding(padding)) {
